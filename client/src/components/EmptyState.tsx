  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gray-100 dark:bg-gray-800 p-6 rounded-full mb-6 shadow-[0_0_30px_rgba(59,130,246,0.2)] dark:shadow-[0_0_30px_rgba(59,130,246,0.15)] ring-1 ring-gray-200/50 dark:ring-gray-700/50"
      >
