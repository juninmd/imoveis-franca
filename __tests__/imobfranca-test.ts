...
describe('imobfranca', () => {
    it('should parse html correctly', async () => {
        ...
        expect(result.imoveis[0].link).toBe('https://imobfranca.com.br/imovel/123/casa-venda');
    });
    ...
    it('should parse html without strong tag correctly', async () => {
        const html = `
            <body>
                ...
                <div class="item-lista">
                    <a href="https://imobfranca.com.br/imovel/123/casa-venda"></a>
                    <h3>Casa em Condominio - Franca</h3>
                    <small>Bairro XYZ</small>
                    R$ 500.000,00
                    <div class="icones">
                    ...
                    <img src="https://imobfranca.com.br/img/casa.jpg" />
                </div>
            </body>
        `;
        const result = await adapter(html);
