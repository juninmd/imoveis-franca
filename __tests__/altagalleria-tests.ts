import { adapter } from '../src/sites/altagalleria';

describe('Alta Galleria Scraper', () => {
  ...
  it('should parse properties correctly', async () => {
    ...
    expect(result.imoveis[0].link).toEqual('https://altagalleria.com.br/imovel/venda/casa/franca/centro/123');
  });
});
